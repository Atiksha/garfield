										...
										<table  class=" table table-responsive" border="0" >
											...
											<h2 >Feedback</h2>
												<tr>
														...
														<td>
															<div class="well">
																<form class="form-horizontal"  method="POST" action="includes/feedback-inc.php">
																	<fieldset>
					...
					<ul class="mdeia-list"><hr>
						<li class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Tom<small><i> june 12,2016</i></small></h4>
								<p> t twxtany thing random twxt any thing random twxtany thing random twxt any thing random twxtany thingany thing random twxtany thing random twxt randomany thing random twxtany thing random twxt twxt<p>
								
								
								<div class="media">
									<div class="media-left">
										<a href="#">
											<img src="..\images\1.jpg" height="60px" width="60px"  class="media-object" alt="image"/> 
										</a>
									</div>
									<div class="media-body">
										<h4 class="media-heading">Sam<small><i> june 12,2016</i></small></h4>
										<p>  thing random twxt twxt<p>
										...
										<div class="media">
											...
											<div class="media-body">
												<h4 class="media-heading">Tom<small><i> june 12,2016</i></small></h4>
												<p> om twxtany thing random twxt twxt<p>
											</div>
										</div>
						...
						<li class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Tom<small><i> june 12,2016</i></small></h4>
								<p> any thing random twxt any thing random twxtany thing random twxt any thing  thing random twxt randomany thing random twxtany thing random twxt twxt<p>
							</div>
						</li>
					</ul>
